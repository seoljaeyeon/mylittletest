...
<style>
	...
	<br><br>
	<div>
	<input style="font-size: 35px; font-weight: bolder;  background-color: #474747; color: white;  border-width: 0;" placeholder="제목을 입력해주세요.">
		<div align="right">
	...
	<div align="right">
		<select style="width: 200px; height:25px; border-radius: 50px; text-align: center; margin-right: 50px;"><option selected>지금 작성</option></select>
