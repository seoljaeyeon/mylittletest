...
<jsp:include page="./include/head.jsp"></jsp:include>
	...
	.write_btn,.reset_btn{
		...
		<form id="writeFrm" name="wiriteFrm" action="writeok.jsp">
			<div class="container">
				...
				<div class="title-container">
	                <input class="title_input" type="text" id="title" name="title" placeholder="제목 입력" spellcheck="false" autofocus autocomplete = "off">
				...
				<div class="box">
					<div class=hint_container><input class="hint_input" type="text" id="hint" name="hint" placeholder="힌트입력"></div>
