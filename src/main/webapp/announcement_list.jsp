...
<style>
	...
	<span style="margin-left: 450px;">
		<a href="announcement_reservation.jsp">
			<button type="button" style="height: 40px; width: 99px; border-radius: 17px; background-color: #333333; color: white;">작성예약목록</button>
		</a>
	</span>
	<span style="margin-left: 10px;">
		<a href="announcement_write.jsp">
			<button type="button" style="height: 40px; width: 95px; border-radius: 17px; background-color: #333333; color: white;">게시글 작성</button>
		</a>
	</span>
