...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('write_btn').addEventListener('click', function() {
        ...
        document.getElementById('noteContent').value = editorHtml;
        document.getElementById('noteCommentary').value = commentaryHtml;
    });
});
</script>
...
<div class="container">
    <form id="writeFrm" class="writeFrm" name="writeFrm" action="writeok.jsp">
        ...
        <div class="title_container">
            <input class="title_input" type="text" id="noteTitle" name="noteTitle" placeholder="제목을 입력해주세요"
        ...
        <div class="box">
            <div class="hint_container"><input class="hint_input" type="text" id="noteHint" name="noteHint" placeholder="힌트를 입력해주세요"></div>
        ...
        <div class="minibox">
            ...
            <div class="button_container">
                <input type="submit" class="write_btn" id="write_btn" name="write_btn" value="작성">
