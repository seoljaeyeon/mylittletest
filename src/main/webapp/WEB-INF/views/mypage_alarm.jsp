...
<div class="mypage_container">
	<div class="profile_box">
	 <input type="file" id="fileInput" style="display:none;">
		...
		<div class="sub_menu">
			<div class="bookmark_list_btn" onclick="location.href='/mylittletest/mypage_bookmark'">즐겨찾기 & 북마크 목록</div>
			<div class="alarm_list_btn" style="margin-top:50px;" onclick="location.href='/mylittletest/mypage_alarm'">알림 목록</div>
		</div>	
	</div>
		...
		<div class="alarm_list">
			...
			<div class="alarm_main">
				...
				<c:forEach var="alarm" items="${ alarm }">
					<div class="alarm">
						<div class="sub" style="width:150px; font-size:18px;">${alarm.alarmType}</div>
						<div class="sub" style="width:450px; overflow:hidden; font-size:18px;">${alarm.alarmNote}</div>
						<div class="sub" style="width:300px; font-size:18px;">${alarm.alarmDate }</div>
					</div>
				</c:forEach>
