...
<style>
	...
	<div class="a">
	<div><div style="display: inline-block; font-size: 30px; font-weight: bolder; margin-left: 50px;" id="my_note">
		<a href="#">내 문제</a>
	</div>
	...
	<script>
		let myNote = document.getElementById("my_note");
